...
const DEFAULT_ARRAY_1 = [2, 6, 8, 0, 3, 5, 9, 7, 4, 1];
const DEFAULT_ARRAY_PALINDROME = [2, 6, 8, 0, 3, 5, 9, 7, 4, 1].reverse();
const DEFAULT_ARRAY_2 = [6, 2, 8, 4, 0, 1, 9, 3, 5, 7];
const DEFAULT_ARRAY_3 = [13, 86]
...
// Affichage
console.log("\n----------- DIFFERENTS -----------");
let arrayDifferents = compareArray(DEFAULT_ARRAY_1, DEFAULT_ARRAY_3);
prettyDisplay(arrayDifferents);

console.log("\n---------- PALINDROMES ----------");
let arrayPalindrome = compareArray(DEFAULT_ARRAY_1, DEFAULT_ARRAY_PALINDROME);
prettyDisplay(arrayPalindrome);

console.log("\n------------- EGAUX ------------");
let arrayEgaux = compareArray(DEFAULT_ARRAY_1, DEFAULT_ARRAY_1);
